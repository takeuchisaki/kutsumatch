...
Shoe.create( name: 'フラットシューズ000', body: 'とてもいい。長時間履いていても疲れない。', shoe_size: '24.0', price: '19000', match_rate: '90', tag_name: 'マーガレット・ハウエル アイデア、マーガレット・ハウエル、ヒール、4.5cm、黒', customer_id: 2 )
Shoe.create( name: 'ユニーク', body: '小指の付け根と薬指の第２関節があったてしまい、とても痛い。もう少し大きくてもよかったかも。', shoe_size: '27.0', price: '15000', match_rate: '40', tag_name: 'KEEN、ブラック、サンダル', customer_id: 3 )
Shoe.create( name: 'ゼラポート ツー サンダル', body: '履きやすいし、とても気にっているが、もうワンサイズ大きくてもよかった気がする。', shoe_size: '28.0', price: '11000', match_rate: '60', tag_name: 'keen、サンダル、ブラック', customer_id: 1 )
Shoe.create( name: 'インスタポンプ フューリー OG', body: 'お気に入りすぎて、色違いを購入。サイズは前回と同じ', shoe_size: '24.0', price: '10000', match_rate: '90', tag_name: 'リーボック、スニーカー、ネイビー', customer_id: 2 )